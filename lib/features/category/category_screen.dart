              ...
              itemBuilder: (context, index) {
                return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              await context.push('/detail/${categoryListData[index].postId}');
                            },
                            child: Card(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: RoundedBackgroundText(
                                                    ...
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        color: categoryListData[index].userType ==
                                                                0
                                                            ? AppColors.primary
                                                            : AppColors.white),
                                                    backgroundColor:
                                                        categoryListData[index].userType == 0
                                                            ? AppColors
                                                                .extraLightGrey
                                                            : AppColors.primary,
                                                    innerRadius: 20.0,
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Text(
                                                      categoryListData[index].travelParticipation
                                                          .toString(),
                                                      style: const TextStyle(
                                                        fontFamily:
                                                            'Pretendard',
                                                  ...
                                                  Text(
                                                      categoryListData[index].localParticipation
                                                          .toString(),
                                                      style: const TextStyle(
                                                        fontFamily:
                                                            'Pretendard',
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                            categoryListData[index].likeCount
                                                                .toString(),
                                                            style:
                                                                const TextStyle(
                                                              fontWeight:
